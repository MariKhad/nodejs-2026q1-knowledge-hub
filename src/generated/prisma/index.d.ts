...
export namespace Prisma {
  ...
  */
  ...
  > = {
    ...
    meta: {
      modelProps: 'user' | 'category' | 'tag' | 'article' | 'comment';
  ...
  export type UserOmit<
    ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs,
  > = $Extensions.GetOmit<
    'id' | 'login' | 'password' | 'role' | 'createdAt' | 'updatedAt',
    ExtArgs['result']['user']
  >;
  ...
  > extends Prisma.PrismaPromise<T> {
    readonly [Symbol.toStringTag]: 'PrismaPromise';
    articles<T extends Tag$articlesArgs<ExtArgs> = {}>(
      args?: Subset<T, Tag$articlesArgs<ExtArgs>>,
    ): Prisma.PrismaPromise<
      | $Result.GetResult<
          Prisma.$ArticlePayload<ExtArgs>,
          T,
  ...
  > extends Prisma.PrismaPromise<T> {
    readonly [Symbol.toStringTag]: 'PrismaPromise';
    author<T extends Article$authorArgs<ExtArgs> = {}>(
      args?: Subset<T, Article$authorArgs<ExtArgs>>,
    ): Prisma__UserClient<
      $Result.GetResult<
        Prisma.$UserPayload<ExtArgs>,
        T,
      ...
      GlobalOmitOptions
    >;
    category<T extends Article$categoryArgs<ExtArgs> = {}>(
      args?: Subset<T, Article$categoryArgs<ExtArgs>>,
    ): Prisma__CategoryClient<
      $Result.GetResult<
        Prisma.$CategoryPayload<ExtArgs>,
        T,
    ...
    comments<T extends Article$commentsArgs<ExtArgs> = {}>(
      ...
      | Null
    >;
    tags<T extends Article$tagsArgs<ExtArgs> = {}>(
      args?: Subset<T, Article$tagsArgs<ExtArgs>>,
    ): Prisma.PrismaPromise<
      | $Result.GetResult<
          Prisma.$TagPayload<ExtArgs>,
          T,
   ...
   * Article.author
   */
  export type Article$authorArgs<
    ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs,
  > = {
    /**
     * Select specific fields to fetch from the User
   ...
   * Article.category
   */
  export type Article$categoryArgs<
    ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs,
  > = {
    /**
     * Select specific fields to fetch from the Category
  ...
  export type CommentOmit<
    ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs,
  > = $Extensions.GetOmit<
    'id' | 'content' | 'articleId' | 'authorId' | 'createdAt' | 'updatedAt',
    ExtArgs['result']['comment']
  >;
  ...
  export type ArticleScalarWhereWithAggregatesInput = {
    ...
    status?:
      | EnumArticleStatusWithAggregatesFilter<'Article'>
      | $Enums.ArticleStatus;
  ...
  export type EnumArticleStatusFilter<$PrismaModel = never> = {
    equals?:
      | $Enums.ArticleStatus
      | EnumArticleStatusFieldRefInput<$PrismaModel>;
    in?:
      | $Enums.ArticleStatus[]
      | ListEnumArticleStatusFieldRefInput<$PrismaModel>;
    notIn?:
      | $Enums.ArticleStatus[]
      | ListEnumArticleStatusFieldRefInput<$PrismaModel>;
  ...
  export type EnumArticleStatusWithAggregatesFilter<$PrismaModel = never> = {
    ...
    notIn?:
      ...
      | ListEnumArticleStatusFieldRefInput<$PrismaModel>;
    not?:
      | NestedEnumArticleStatusWithAggregatesFilter<$PrismaModel>
      | $Enums.ArticleStatus;
    _count?: NestedIntFilter<$PrismaModel>;
  ...
  export type ArticleCreateNestedManyWithoutCategoryInput = {
    create?:
      | XOR<
          ArticleCreateWithoutCategoryInput,
          ArticleUncheckedCreateWithoutCategoryInput
        >
      | ArticleCreateWithoutCategoryInput[]
      | ArticleUncheckedCreateWithoutCategoryInput[];
    connectOrCreate?:
      | ArticleCreateOrConnectWithoutCategoryInput
      | ArticleCreateOrConnectWithoutCategoryInput[];
  ...
  export type ArticleUpdateManyWithoutCategoryNestedInput = {
    ...
    connectOrCreate?:
      ...
      | ArticleCreateOrConnectWithoutCategoryInput[];
    upsert?:
      | ArticleUpsertWithWhereUniqueWithoutCategoryInput
      | ArticleUpsertWithWhereUniqueWithoutCategoryInput[];
    createMany?: ArticleCreateManyCategoryInputEnvelope;
    set?: ArticleWhereUniqueInput | ArticleWhereUniqueInput[];
    disconnect?: ArticleWhereUniqueInput | ArticleWhereUniqueInput[];
    ...
    connect?: ArticleWhereUniqueInput | ArticleWhereUniqueInput[];
    update?:
      | ArticleUpdateWithWhereUniqueWithoutCategoryInput
      | ArticleUpdateWithWhereUniqueWithoutCategoryInput[];
    updateMany?:
      | ArticleUpdateManyWithWhereWithoutCategoryInput
      | ArticleUpdateManyWithWhereWithoutCategoryInput[];
    deleteMany?: ArticleScalarWhereInput | ArticleScalarWhereInput[];
  };
  ...
  export type ArticleUpsertWithWhereUniqueWithoutCategoryInput = {
    where: ArticleWhereUniqueInput;
    update: XOR<
      ArticleUpdateWithoutCategoryInput,
      ArticleUncheckedUpdateWithoutCategoryInput
    >;
    create: XOR<
      ArticleCreateWithoutCategoryInput,
      ArticleUncheckedCreateWithoutCategoryInput
  ...
  export type ArticleUpdateManyWithWhereWithoutCategoryInput = {
    ...
    data: XOR<
      ArticleUpdateManyMutationInput,
      ArticleUncheckedUpdateManyWithoutCategoryInput
    >;
  };
